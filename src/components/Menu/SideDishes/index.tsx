...
const SideDishes = () => {
    const sideDishSublists: SideDishesProps[][][] = [
      [
        [
    ...
    <div className="container">
      <div >
        <Title icon={sideDishesIcon} text="Acompanhamentos" />
            ...
            {
              sideDishSublists.map((list, index) => (
                <div id={index.toString()} key={index.toString()} className="mainList">
                  {
                    list.map((subList, subIndex)=>(
                      subList.map((content, contentIndex)=>(
                        <div key={contentIndex} id={subIndex.toString()} className="sideDishInfo">
                          <p>{content.sideDish}</p>
                          <p>{content.price}</p>
                        </div>
                      ))
                    ))
